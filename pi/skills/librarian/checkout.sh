...
Clones and normalizes remotes to SSH URLs, e.g.:
  git@github.com:mitsuhiko/minijinja.git
...
# If remote URL changed (e.g. host shorthand), normalize to canonical SSH URL.
